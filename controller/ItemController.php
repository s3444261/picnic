...
class ItemController {
                ...
                if (isset($_POST['confirm'])) {
                    ...
                    try {
                        ...
                        $itemID = $h->addItem(
                            $_SESSION['userID'],
                            $_SESSION['itemAdd'],
                            intval($_SESSION['itemAdd']['category']));
    ...
    /**
     * Creates a low-resolution thumbnail from a high-resolution image.
     *
    ...
    private function createThumbnail(
        ...
        string $targetFile,
        int $targetWidth,
        int $targetHeight, $background = false) {
        ...
        $new_image = imagecreatetruecolor($targetWidth, $targetHeight); // creates new image, but with black background
