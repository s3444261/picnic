...
class ItemCommentsTest extends PicnicTestCaseOld {
	...
	public function testGetComments(): void {
		...
		$sut->itemID = 1;
		$itemComments = $sut->getComments();
		
		$i = 1;
		foreach($itemComments as $itemComment){
			$this->assertEquals($i, $itemComment->item_commentID);
			$this->assertEquals(1, $itemComment->itemID);
			$this->assertEquals($i, $itemComment->commentID);
			$i++;
		}
	}
	
	public function testGetItemCommentInvalidCommentId(): void {
	...
	public function testGetItemCommentValidCommentId(): void {
		$sut = $this->createDefaultSut();
		$sut->commentID = 2;
		try {
			$sut->getItemComment();
