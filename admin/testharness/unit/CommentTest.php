...
final class CommentTest extends PicnicTestCase{
	...
	protected function setUp(): void {
		...
		$u1 = new User($pdo, [self::USER => self::USER_NAME_1, self::EMAIL => self::USER_EMAIL_1, self::PASSWORD => self::USER_PASSWORD_1]);
		$u2 = new User($pdo, [self::USER => self::USER_NAME_2, self::EMAIL => self::USER_EMAIL_2, self::PASSWORD => self::USER_PASSWORD_2]);
		$c1 = new Comment($pdo, [self::USER_ID => self::USER_ID_1, self::COMMENT => self::COMMENT_1]);
		$c2 = new Comment($pdo, [self::USER_ID => self::USER_ID_1, self::COMMENT => self::COMMENT_2]);
		$c3 = new Comment($pdo, [self::USER_ID => self::USER_ID_1, self::COMMENT => self::COMMENT_3]);
