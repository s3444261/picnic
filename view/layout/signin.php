            ...
            <div class="col-xs-8 col-sm-8 col-md-6 hidden-xs">
                <h2>
                    <?php if (!isset ($_SESSION [MODULE])) { ?>
                        Login
                    <?php } else { ?>
                        You are already signed in as <?php echo $_SESSION ['user'] ?>.
                    <?php } ?>
                </h2>
            </div>
            <div class="col-xs-2 col-sm-2 col-md-3"></div>
        ...
        <div class="row">
            ...
            <div class="col-xs-8 col-sm-8 col-md-6">
				...
				<?php if (!isset ($_SESSION [MODULE])) { ?>
                    ...
                    <form data-toggle="validator" role="form" class="form-inline" method="post" action="Login">
                    ...
                    <div>
                        ...
                        <a class="btn btn-secondary" role="button" href="<?php echo BASE . '/Signup' ?>">Sign up now!</a>
                    </div>
				<?php } ?>
