    ...
    <div class="row">
        ...
        <div class="col-9">
            <div class="jumbotron panel panel-default">
                ...
                <form data-toggle="validator" role="form" method="post" action="../EditConfirm">
                    <div class="form-group">
                        <label for="status">Type</label>
                        <label class="radio-inline"><input type="radio" name="status" value="ForSale" <?php if (isset($this->data['item']) && isset($this->data['item']['status']) && $this->data['item']['status'] == 'ForSale') { echo 'checked="checked"'; } ?>>For Sale</label>
                        <label class="radio-inline"><input type="radio" name="status" value="Wanted" <?php if (isset($this->data['item']) &&isset($this->data['item']['status']) && $this->data['item']['status'] == 'Wanted') { echo 'checked="checked"'; } ?>>Wanted</label>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="majorCategory" name="majorCategory" onchange="refreshSubCategories()" required>
							<?php foreach ( $this->data['categories'] as $category ) { ?>
                                <option id="<?php echo $category['categoryID'] ?>" value="<?php echo $category['categoryID'] ?>" <?php if ($this->data['item']['majorCategory'] == $category['categoryID']) { echo 'selected'; }  ?>><?php echo $category['category'] ?></option>
							<?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <label class="radio-inline"><input type="radio" name="itemcondition" value="New" <?php if (isset($this->data['item']) && isset($this->data['item']['itemcondition']) && $this->data['item']['itemcondition'] == 'New') { echo 'checked="checked"'; } ?>>New</label>
                <label class="radio-inline"><input type="radio" name="itemcondition" value="Used" <?php if (isset($this->data['item']) &&isset($this->data['item']['itemcondition']) && $this->data['item']['itemcondition'] == 'Used') { echo 'checked="checked"'; } ?>>Used</label>
            </div>
            <div class="form-group">
